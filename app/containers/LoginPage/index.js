...
import {
  Grid, Header, Form, Segment, Input, Button, Message,
        ...
        <Grid.Column>
          ...
          <Form size="large" onSubmit={this.handleSubmit}>
            <Segment stacked>
              <Form.Field>
                <Input
                  name="username" icon="user" iconPosition="left" error={!!errors.username}
                  placeholder="E-mail address" onChange={this.handleChange} value={data.username || ''}
                />
                {errors.username && <Message warning header={errors.username} />}
              </Form.Field>
              <Form.Field>
                <Input
                  name="password" icon="lock" iconPosition="left" error={!!errors.password}
                  placeholder="Password" type="password" onChange={this.handleChange} value={data.password || ''}
                />
                {errors.password && <Message warning header={errors.password} />}
              </Form.Field>
              <Button
                size="large" color="teal" fluid
                type="submit" loading={isRequesting} disabled={isRequesting}
              >
                Login
              </Button>
            </Segment>
