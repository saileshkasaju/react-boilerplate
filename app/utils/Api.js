...
class Api {
   ...
   */
  static dataLoader(
    apiUri, onSuccess, onError, data, token, metaData = '', ...actionArguments
  ) {
  ...
  static multipartPost(
    apiUri, onSuccess, onError, data, document, token = '',
    metaData = '', ...actionArguments
  ) {
  ...
  static get(apiUri, onSuccess, onError, ...actionArguments) {
    return this.dataLoader(
      apiUri, onSuccess, onError, undefined, ...actionArguments
    );
  }
  /*
   ...
   */
  static patch(
    apiUri, onSuccess, onError, data = {}, token, ...actionArguments
  ) {
